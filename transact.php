...
<br><br>
	...
	<table border="0px" style="background-color:#75A1D0;">
		...
		<td><select name="user">
			...
			<tr><td></td><td><input type="submit" onclick="transaction.php" name="submit" value="Submit" align=center style="margin-top: 10px; width:6em; height:2em; font-size:15px; background-color: skyblue; font-weight: bold;"></td></tr>
	</table>
